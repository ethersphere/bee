...
// startAPIServer starts the API server for native builds using a TCP listener.
func startAPIServer(ctx context.Context, addr string, handler http.Handler, errorLogWriter io.Writer, logger log.Logger) (*http.Server, io.Closer, error) {
