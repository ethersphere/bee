...
func NewDevBee(logger logging.Logger, o *DevOptions) (b *DevBee, err error) {
	...
	if debugAPIService != nil {
		...
		debugAPIService.Configure(swarmAddress, p2ps, pingPong, kad, lightNodes, storer, tagService, acc, pseudoset, true, true, false, mockSwap, mockChequebook, batchStore, post, postageContract, traversalService)
	}
