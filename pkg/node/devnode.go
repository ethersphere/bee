...
func NewDevBee(logger logging.Logger, o *DevOptions) (b *DevBee, err error) {
	...
	apiService, _ := api.New(tagService, storer, nil, pssService, traversalService, pinningService, feedFactory, post, postageContract, nil, signer, logger, tracer, api.Options{
