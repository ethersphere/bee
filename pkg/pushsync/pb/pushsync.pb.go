...
type Delivery struct {
	...
	Replicate bool   `protobuf:"varint,4,opt,name=Replicate,proto3" json:"Replicate,omitempty"`
}
...
func (m *Delivery) GetReplicate() bool {
	if m != nil {
		return m.Replicate
	}
	return false
...
var fileDescriptor_723cf31bfc02bfd6 = []byte{
	...
	0x28, 0xae, 0xcc, 0x4b, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x80, 0xf1, 0x95, 0x72,
	...
	0x5c, 0x92, 0x98, 0x5b, 0x20, 0xc1, 0x0c, 0x16, 0x84, 0x70, 0x84, 0x64, 0xb8, 0x38, 0x83, 0x52,
	0x0b, 0x72, 0x32, 0x93, 0x13, 0x4b, 0x52, 0x25, 0x58, 0x14, 0x18, 0x35, 0x38, 0x82, 0x10, 0x02,
	0x4a, 0xe1, 0x5c, 0xec, 0x41, 0xa9, 0xc9, 0xa9, 0x99, 0x05, 0x25, 0x78, 0x2c, 0x93, 0xe1, 0xe2,
	0x0c, 0xce, 0x4c, 0xcf, 0x4b, 0x2c, 0x29, 0x2d, 0x4a, 0x85, 0xda, 0x88, 0x10, 0x00, 0x59, 0xeb,
	0x97, 0x9f, 0x97, 0x9c, 0x0a, 0xb3, 0x16, 0xcc, 0x71, 0x92, 0x39, 0xf1, 0x48, 0x8e, 0xf1, 0xc2,
	0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1,
	0xc6, 0x63, 0x39, 0x86, 0x28, 0xa6, 0x82, 0xa4, 0x24, 0x36, 0xb0, 0xaf, 0x8d, 0x01, 0x01, 0x00,
	0x00, 0xff, 0xff, 0xa7, 0x27, 0x33, 0xfd, 0x07, 0x01, 0x00, 0x00,
}
...
func (m *Delivery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Replicate", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
