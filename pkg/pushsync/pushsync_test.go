...
func createPushSyncNode(t *testing.T, addr swarm.Address, recorder *streamtest.Recorder, validators []swarm.Validator, mockOpts ...mock.Option) (*pushsync.PushSync, *localstore.DB, *tags.Tags, accounting.Interface) {
	t.Helper()
	...
	return pushsync.New(recorder, storer, mockTopology, mtag, nil, logger, mockAccounting, mockPricer, nil), storer, mtag, mockAccounting
}
