...
type transactionServiceMock struct {
	send                 func(ctx context.Context, request *transaction.TxRequest, boostPercentage uint64) (txHash common.Hash, err error)
...
func (m *transactionServiceMock) Send(ctx context.Context, request *transaction.TxRequest, boostPercent uint64) (txHash common.Hash, err error) {
	if m.send != nil {
...
func WithSendFunc(f func(ctx context.Context, request *transaction.TxRequest, boostPercentage uint64) (txHash common.Hash, err error)) Option {
...
func WithABISend(abi *abi.ABI, txHash common.Hash, expectedAddress common.Address, expectedValue *big.Int, method string, params ...interface{}) Option {
	return optionFunc(func(s *transactionServiceMock) {
		s.send = func(ctx context.Context, request *transaction.TxRequest, _ uint64) (common.Hash, error) {
