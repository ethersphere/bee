...
// FeeHistorySuggestedFees are max-fee-per-gas style estimates from eth_feeHistory over the last 100 blocks.
...
type FeeHistorySuggestedFees struct {
	Low        *big.Int
	Market     *big.Int
	Aggressive *big.Int
}
...
type Backend interface {
	...
	SuggestedFeesFromFeeHistory(ctx context.Context) (*FeeHistorySuggestedFees, error)
}
