...
func (svc *batchService) Create(id, owner []byte, totalAmout, normalisedBalance *big.Int, depth, bucketDepth uint8, immutable bool, txHash common.Hash) error {
	...
	svc.logger.Debug("batch created", "batch_id", batch.ID, "tx", txHash, "tx_checksum", cs)
	return nil
}
...
func (svc *batchService) TopUp(id []byte, totalAmout, normalisedBalance *big.Int, txHash common.Hash) error {
	...
	svc.logger.Debug("topped up batch", "batch_id", b.ID, "old_value", b.Value, "new_value", normalisedBalance, "tx", txHash, "tx_checksum", cs)
	return nil
}
...
func (svc *batchService) UpdateDepth(id []byte, depth uint8, normalisedBalance *big.Int, txHash common.Hash) error {
	...
	svc.logger.Debug("updated depth of batch", "batch_id", b.ID, "old_depth", b.Depth, "new_depth", depth, "tx", txHash, "tx_checksum", cs)
	return nil
}
...
func (svc *batchService) UpdatePrice(price *big.Int, txHash common.Hash) error {
	...
	svc.logger.Debug("updated chain price", "new_price", price, "tx", txHash, "tx_checksum", sum)
	return nil
}
