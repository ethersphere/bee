...
// func (s *store) getReservateState() reserveState {
// 	s.rsMtx.Lock()
// 	defer s.rsMtx.Unlock()
// 	return *s.rs
// }

// func (s *store) setRadius(r uint8) {
// 	s.rsMtx.Lock()
// 	defer s.rsMtx.Unlock()
// 	s.rs.Radius = r
// }

// func (s *store) setStorageRadius(r uint8) {
// 	s.rsMtx.Lock()
// 	defer s.rsMtx.Unlock()
// 	s.rs.StorageRadius = r
// }

// func (s *store) addAvailable(a int64) {
// 	s.rsMtx.Lock()
// 	defer s.rsMtx.Unlock()
// 	s.rs.Available += a
// }
