...
func Test_UnmarshalBinary(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "fork with metadata where metadata size value is less then metadata content (size 89, want 93)",
		...
		{
			name:    "fork with vaild metadata (size is 93, want 93)",
		...
		{
			name:    "fork with metadata where metadata size value exceeds actual metadata size (size is 95, want 93)",
		...
		{
			name:    "fork with metadata where metadata size value exceeds actual metadata size (size is 96, want 93)",
