...
var (
	//go:embed mainnet_steaking_abi.json
...
var (
	Testnet = ChainConfig{
		...
		BzzTokenAddress:        common.HexToAddress(abi.TestnetBzzTokenAddress),
		...
		BzzTokenABI:       abi.TestnetBzzTokenABI,
	...
	Mainnet = ChainConfig{
		...
		BzzTokenAddress:        common.HexToAddress("0x19062190B1925b5b6689D7073fDfC8c2976EF8Cb"),
