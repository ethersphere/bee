...
//
// The slices are only valid for the duration of the ChainWrite call they are
// passed to; producers may reuse the backing arrays for the next chunk. A
// writer that retains one beyond the call must copy it first.
