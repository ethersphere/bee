...
func NewPipelineBuilder(ctx context.Context, s storage.SimpleChunkPutter, encrypt bool) pipeline.Interface {
	if encrypt {
...
func newPipeline(ctx context.Context, s storage.SimpleChunkPutter) pipeline.Interface {
...
func newShortPipelineFunc(ctx context.Context, s storage.SimpleChunkPutter) func() pipeline.ChainWriter {
...
func newEncryptionPipeline(ctx context.Context, s storage.SimpleChunkPutter) pipeline.Interface {
...
// needed by the hashTrieWriter.
func newShortEncryptionPipelineFunc(ctx context.Context, s storage.SimpleChunkPutter) func() pipeline.ChainWriter {
	return func() pipeline.ChainWriter {
		lsw := store.NewStoreWriter(ctx, s, nil)
		b := bmt.NewBmtWriter(lsw)
