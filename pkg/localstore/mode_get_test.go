...
func TestModeGetRequest(t *testing.T) {
	...
	t.Run("first get", func(t *testing.T) {
		...
		t.Run("gc index", newGCIndexTest(db, ch, uploadTimestamp, uploadTimestamp, 1, nil, postage.NewStamp(ch.Stamp().BatchID(), nil, nil)))
	...
	t.Run("second get", func(t *testing.T) {
		...
		t.Run("gc index", newGCIndexTest(db, ch, uploadTimestamp, accessTimestamp, 1, nil, postage.NewStamp(ch.Stamp().BatchID(), nil, nil)))
