...
func TestGetStake(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		prevStake := big.NewInt(0)
		expectedCallData, err := stakingContractABI.Pack("nodeEffectiveStake", owner)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("with invalid call data", func(t *testing.T) {
		...
		prevStake := big.NewInt(0)
		expectedCallData, err := stakingContractABI.Pack("nodeEffectiveStake", common.BytesToHash(addr.Bytes()))
		if err != nil {
			t.Fatal(err)
		}
