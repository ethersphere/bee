...
type Peers struct {
	BzzAddress [][]byte `protobuf:"bytes,1,rep,name=BzzAddress,proto3" json:"BzzAddress,omitempty"`
}
...
func (m *Peers) GetBzzAddress() [][]byte {
	if m != nil {
		return m.BzzAddress
	}
	return nil
...
var fileDescriptor_d635d1ead41ba02c = []byte{
	...
	0x62, 0x05, 0x33, 0x24, 0x18, 0x15, 0x18, 0x35, 0x78, 0x83, 0x20, 0x1c, 0x25, 0x75, 0x2e, 0xd6,
	0x80, 0xd4, 0xd4, 0xa2, 0x62, 0x21, 0x39, 0x2e, 0x2e, 0xa7, 0xaa, 0x2a, 0xc7, 0x94, 0x94, 0xa2,
	0xd4, 0xe2, 0x62, 0x09, 0x46, 0x05, 0x66, 0x0d, 0x9e, 0x20, 0x24, 0x11, 0x25, 0x27, 0x64, 0x79,
	0x21, 0x09, 0x2e, 0x76, 0xff, 0xb2, 0xd4, 0xa2, 0x9c, 0xc4, 0x4a, 0xb0, 0x71, 0x3c, 0x41, 0x30,
	0xae, 0x90, 0x14, 0x17, 0x47, 0x68, 0x5e, 0x0a, 0x44, 0x8a, 0x09, 0x2c, 0x05, 0xe7, 0x3b, 0x49,
	0x9c, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x13, 0x1e, 0xcb,
	0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x12, 0x1b, 0xd8, 0xe9, 0xc6, 0x80,
	0x00, 0x00, 0x00, 0xff, 0xff, 0xba, 0xd1, 0xf6, 0x9b, 0xc8, 0x00, 0x00, 0x00,
}
...
func (m *Peers) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BzzAddress) > 0 {
		for iNdEx := len(m.BzzAddress) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.BzzAddress[iNdEx])
			copy(dAtA[i:], m.BzzAddress[iNdEx])
			i = encodeVarintHive(dAtA, i, uint64(len(m.BzzAddress[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *Peers) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.BzzAddress = append(m.BzzAddress, make([]byte, postIndex-iNdEx))
			copy(m.BzzAddress[len(m.BzzAddress)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipHive(dAtA[iNdEx:])
