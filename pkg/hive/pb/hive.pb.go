...
var fileDescriptor_d635d1ead41ba02c = []byte{
	...
	,
}
...
func (m *BzzAddress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChequebookAddress) > 0 {
		...
		i = encodeVarintHive(dAtA, i, uint64(len(m.ChequebookAddress)))
		i--
		dAtA[i] = 0x32
	}
	if m.Timestamp != 0 {
		i = encodeVarintHive(dAtA, i, uint64(m.Timestamp))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Nonce) > 0 {
...
func (m *BzzAddress) Size() (n int) {
	...
	if m.Timestamp != 0 {
		n += 1 + sovHive(uint64(m.Timestamp))
	}
