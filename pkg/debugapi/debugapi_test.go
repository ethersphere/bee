...
func newTestServer(t *testing.T, o testServerOptions) *testServer {
	...
	s.Configure(o.Overlay, o.P2P, o.Pingpong, topologyDriver, ln, o.Storer, o.Tags, acc, settlement, true, true, true, swapserv, chequebook, o.BatchStore, o.Post, o.PostageContract, o.Traverser)
...
func TestServer_Configure(t *testing.T) {
	...
	s.Configure(o.Overlay, o.P2P, o.Pingpong, topologyDriver, ln, o.Storer, o.Tags, acc, settlement, true, true, true, swapserv, chequebook, nil, mockpost.New(), nil, nil)
