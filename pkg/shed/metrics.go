...
func newMetrics() metrics {
	...
	return metrics{
		...
		WriteBatchFailCount: prometheus.NewCounter(prometheus.CounterOpts{
			Namespace: m.Namespace,
			Subsystem: subsystem,
			Name:      "db_write_batch_failure_count",
