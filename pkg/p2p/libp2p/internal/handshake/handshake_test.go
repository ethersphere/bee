...
func TestHandshake(t *testing.T) {
	...
	handshakeService, err := handshake.New(signer1, aaddresser, senderMatcher, nil, node1Info.BzzAddress.Overlay, networkID, true, trxHash, testWelcomeMessage, node1AddrInfo.ID, logger)
	if err != nil {
		t.Fatal(err)
	}
