...
type BzzAddress struct {
	...
	RTCUnderlay [][]byte `protobuf:"bytes,4,rep,name=RTCUnderlay,proto3" json:"RTCUnderlay,omitempty"`
}
...
func (m *BzzAddress) GetRTCUnderlay() [][]byte {
	if m != nil {
		return m.RTCUnderlay
	}
	return nil
}
...
var fileDescriptor_a77305914d5d202f = []byte{
	...
	,
}
...
func (m *BzzAddress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.RTCUnderlay) > 0 {
		for iNdEx := len(m.RTCUnderlay) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.RTCUnderlay[iNdEx])
			copy(dAtA[i:], m.RTCUnderlay[iNdEx])
			i = encodeVarintHandshake(dAtA, i, uint64(len(m.RTCUnderlay[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *BzzAddress) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RTCUnderlay", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RTCUnderlay = append(m.RTCUnderlay, make([]byte, postIndex-iNdEx))
			copy(m.RTCUnderlay[len(m.RTCUnderlay)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipHandshake(dAtA[iNdEx:])
