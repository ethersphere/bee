...
type BzzAddress struct {
	...
	ChequebookAddress []byte `protobuf:"bytes,6,opt,name=ChequebookAddress,proto3" json:"ChequebookAddress,omitempty"`
}
...
func (m *BzzAddress) GetTimestamp() int64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func (m *BzzAddress) GetChequebookAddress() []byte {
	if m != nil {
		return m.ChequebookAddress
	}
	return nil
}
...
var fileDescriptor_a77305914d5d202f = []byte{
	...
	,
}
...
func (m *BzzAddress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ChequebookAddress) > 0 {
		i -= len(m.ChequebookAddress)
		copy(dAtA[i:], m.ChequebookAddress)
		i = encodeVarintHandshake(dAtA, i, uint64(len(m.ChequebookAddress)))
		i--
		dAtA[i] = 0x32
	}
	if m.Timestamp != 0 {
		i = encodeVarintHandshake(dAtA, i, uint64(m.Timestamp))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Nonce) > 0 {
...
func (m *BzzAddress) Size() (n int) {
	...
	if m.Timestamp != 0 {
		n += 1 + sovHandshake(uint64(m.Timestamp))
	}
	l = len(m.ChequebookAddress)
	if l > 0 {
		n += 1 + l + sovHandshake(uint64(l))
	}
	return n
...
func (m *BzzAddress) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChequebookAddress", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ChequebookAddress = append(m.ChequebookAddress[:0], dAtA[iNdEx:postIndex]...)
			if m.ChequebookAddress == nil {
				m.ChequebookAddress = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
