...
func pipelineFactory(s storage.Putter, encrypt bool, rsParity uint8) func() pipeline.Interface {
	return func() pipeline.Interface {
		return builder.NewPipelineBuilder(context.Background(), s, encrypt, rsParity)
	}
}
