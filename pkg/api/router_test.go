	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedStatuses: []struct {
				...
				{"/chunks/stream", []string{"GET"}, http.StatusNoContent},
				{"/chunks/stream/download", []string{"GET"}, http.StatusNoContent},
				...
				{"/pss/subscribe/{topic}", []string{"GET"}, http.StatusNoContent},
		...
		},
		{
			...
			expectedStatuses: []struct {
				...
				{"/chunks/stream/download", nil, http.StatusServiceUnavailable},
