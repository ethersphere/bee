...
func TestPinChunkHandler(t *testing.T) {
	...
	t.Run("pin-bad-address", func(t *testing.T) {
		jsonhttptest.Request(t, client, http.MethodPost, "/chunks-pin/abcd1100zz", http.StatusBadRequest,
	...
	t.Run("list-pins-zero-pins", func(t *testing.T) {
		jsonhttptest.Request(t, client, http.MethodGet, "/chunks-pin", http.StatusOK,
	...
	t.Run("pin-absent-chunk", func(t *testing.T) {
		jsonhttptest.Request(t, client, http.MethodPost, "/chunks-pin/123456", http.StatusNotFound,
			jsonhttptest.WithExpectedJSONResponse(jsonhttp.StatusResponse{
	...
	t.Run("unpin-while-not-pinned", func(t *testing.T) {
		...
		jsonhttptest.Request(t, client, http.MethodDelete, "/chunks-pin/"+hash.String(), http.StatusBadRequest,
			jsonhttptest.WithExpectedJSONResponse(jsonhttp.StatusResponse{
	...
	t.Run("pin-chunk-1", func(t *testing.T) {
		...
		jsonhttptest.Request(t, client, http.MethodPost, "/chunks-pin/"+hash.String(), http.StatusOK,
			jsonhttptest.WithExpectedJSONResponse(jsonhttp.StatusResponse{
				Message: http.StatusText(http.StatusOK),
				Code:    http.StatusOK,
			}),
		...
		jsonhttptest.Request(t, client, http.MethodGet, "/chunks-pin/"+hash.String(), http.StatusOK,
	...
	t.Run("unpin-chunk-1", func(t *testing.T) {
		jsonhttptest.Request(t, client, http.MethodDelete, "/chunks-pin/"+hash.String(), http.StatusOK,
			jsonhttptest.WithExpectedJSONResponse(jsonhttp.StatusResponse{
				Message: http.StatusText(http.StatusOK),
				Code:    http.StatusOK,
			}),
	...
	t.Run("unpin-chunk-2", func(t *testing.T) {
		...
		jsonhttptest.Request(t, client, http.MethodGet, "/chunks-pin/"+hash.String(), http.StatusNotFound,
			jsonhttptest.WithExpectedJSONResponse(jsonhttp.StatusResponse{
				Message: http.StatusText(http.StatusNotFound),
				Code:    http.StatusNotFound,
			}),
	...
	t.Run("list-chunks", func(t *testing.T) {
		...
		jsonhttptest.Request(t, client, http.MethodPost, "/chunks-pin/"+hash2.String(), http.StatusOK,
			jsonhttptest.WithExpectedJSONResponse(jsonhttp.StatusResponse{
				Message: http.StatusText(http.StatusOK),
				Code:    http.StatusOK,
			}),
