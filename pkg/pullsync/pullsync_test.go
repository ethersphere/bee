...
func newPullSync(s p2p.Streamer, o ...mock.Option) (*pullsync.Syncer, *mock.PullStorage) {
	...
	return pullsync.New(s, storage, unwrap, validStamp, logger, mockbatchstore.New(), swarm.MustParseHexAddress("ca1e9f3938cc1425c6061b96ad9eb93e134dfe8734ad490164ef20af9d1cf59c")), storage
}
