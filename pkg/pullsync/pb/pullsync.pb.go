...
type Chunk struct {
	...
	BatchHash []byte `protobuf:"bytes,3,opt,name=BatchHash,proto3" json:"BatchHash,omitempty"`
}
...
func (m *Chunk) GetBatchHash() []byte {
	if m != nil {
		return m.BatchHash
	}
	return nil
...
var fileDescriptor_d1dee042cf9c065c = []byte{
	...
	,
}
...
func (m *Chunk) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BatchHash) > 0 {
		...
		i = encodeVarintPullsync(dAtA, i, uint64(len(m.BatchHash)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.BatchID) > 0 {
