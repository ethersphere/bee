...
func TestDB_schemaFieldKey(t *testing.T) {
	...
	t.Run("empty name or type", func(t *testing.T) {
		_, err := db.schemaFieldKey(ctx, "", "")
		if err == nil {
			t.Error("error not returned, but expected")
		}
		_, err = db.schemaFieldKey(ctx, "", "type")
		if err == nil {
			t.Error("error not returned, but expected")
		}

		_, err = db.schemaFieldKey(ctx, "test", "")
		if err == nil {
			t.Error("error not returned, but expected")
		}
	})
	...
	t.Run("same field", func(t *testing.T) {
		key1, err := db.schemaFieldKey(ctx, "test", "undefined")
		if err != nil {
			t.Fatal(err)
		}

		key2, err := db.schemaFieldKey(ctx, "test", "undefined")
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("different fields", func(t *testing.T) {
		key1, err := db.schemaFieldKey(ctx, "test1", "undefined")
		if err != nil {
			t.Fatal(err)
		}

		key2, err := db.schemaFieldKey(ctx, "test2", "undefined")
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("same field name different types", func(t *testing.T) {
		_, err := db.schemaFieldKey(ctx, "the-field", "one-type")
		if err != nil {
			t.Fatal(err)
		}

		_, err = db.schemaFieldKey(ctx, "the-field", "another-type")
		if err == nil {
			t.Error("error not returned, but expected")
		}
	})
...
func TestDB_schemaIndexPrefix(t *testing.T) {
	...
	t.Run("same name", func(t *testing.T) {
		id1, err := db.schemaIndexPrefix(ctx, "test")
		if err != nil {
			t.Fatal(err)
		}

		id2, err := db.schemaIndexPrefix(ctx, "test")
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("different names", func(t *testing.T) {
		id1, err := db.schemaIndexPrefix(ctx, "test1")
		if err != nil {
			t.Fatal(err)
		}

		id2, err := db.schemaIndexPrefix(ctx, "test2")
		if err != nil {
			t.Fatal(err)
		}
...
func TestDB_RenameIndex(t *testing.T) {
	...
	t.Run("empty names", func(t *testing.T) {
		...
		// empty names
		renamed, err := db.RenameIndex(ctx, "", "")
		if err == nil {
			t.Error("error not returned, but expected")
		}
		if renamed {
		...
		// empty index name
		renamed, err = db.RenameIndex(ctx, "", "new")
		if err == nil {
			t.Error("error not returned, but expected")
		}
		if renamed {
		...
		renamed, err = db.RenameIndex(ctx, "current", "")
		if err == nil {
			t.Error("error not returned, but expected")
		}
		if renamed {
	...
	t.Run("same names", func(t *testing.T) {
		...
		renamed, err := db.RenameIndex(ctx, "index1", "index1")
		if err != nil {
			t.Error(err)
		}
		if renamed {
	...
	t.Run("unknown name", func(t *testing.T) {
		...
		renamed, err := db.RenameIndex(ctx, "index1", "index1new")
		if err != nil {
			t.Error(err)
		}
		if renamed {
	...
	t.Run("valid names", func(t *testing.T) {
		...
		// initial indexes
		key1, err := db.schemaIndexPrefix(ctx, "index1")
		if err != nil {
			t.Fatal(err)
		}
		key2, err := db.schemaIndexPrefix(ctx, "index2")
		if err != nil {
			t.Fatal(err)
		}
		...
		key1same, err := db.schemaIndexPrefix(ctx, "index1new")
		if err != nil {
			t.Fatal(err)
		}
		if key1 != key1same {
		...
		key2same, err := db.schemaIndexPrefix(ctx, "index2")
		if err != nil {
			t.Fatal(err)
		}
		if key2 != key2same {
		...
		key1renew, err := db.schemaIndexPrefix(ctx, "index1")
		if err != nil {
			t.Fatal(err)
		}
		if key1 == key1renew {
