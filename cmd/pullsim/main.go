...
func main() {
	var (
		...
		topology = flag.String("topology", "full", "topology: full|ring|k-nearest|random|kademlia")
		degree   = flag.Int("degree", 6, "peer degree (ring/k-nearest/random; peers per bin for kademlia)")
