...
const (
	...
	optionNameStubChainBackend           = "stub-chain-backend" //TODO rename, add docs about no overlay,postage,accounting,settlements
...
func (c *command) setAllFlags(cmd *cobra.Command) {
	...
	cmd.Flags().Bool(optionNameStubChainBackend, false, "use an offline chain backend")
