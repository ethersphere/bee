...
const (
	...
	optionNameSwapBackendEnabled         = "swap-backend-enable" //TODO rename, add docs about no overlay,postage,accounting,settlements
...
func (c *command) setAllFlags(cmd *cobra.Command) {
	...
	cmd.Flags().Bool(optionNameSwapBackendEnabled, true, "enable swap backend")
