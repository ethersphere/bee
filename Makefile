...
LDFLAGS ?= -s -w -X github.com/ethersphere/bee.commitHash="$(COMMIT_HASH)" -X github.com/ethersphere/bee.commitTime="$(COMMIT_TIME)" -X github.com/ethersphere/bee/pkg/p2p/libp2p2.reachabilityOverridePublic="$(REACHABILITY_OVERRIDE_PUBLIC)"
